...
export default function Logger(title: string, message: string, date: boolean, color: string[]): void {
  if(!color) color = [colors.blue, colors.default]; 
